...
inline fun IntOffset(x: Int, y: Int): IntOffset = IntOffset(packInts(x, y))
...
operator fun Offset.plus(offset: IntOffset): Offset = Offset(x + offset.x, y + offset.y)

operator fun Offset.minus(offset: IntOffset): Offset = Offset(x - offset.x, y - offset.y)

operator fun IntOffset.plus(offset: Offset): Offset = Offset(x + offset.x, y + offset.y)

operator fun IntOffset.minus(offset: Offset): Offset = Offset(x - offset.x, y - offset.y)
