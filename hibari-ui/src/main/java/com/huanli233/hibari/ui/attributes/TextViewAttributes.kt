...
import com.highcapable.yukireflection.type.android.TextViewClass
...
fun Modifier.text(text: CharSequence): Modifier {
    return this.then(ViewAttribute(object : AttributeApplier<TextView, CharSequence> {
...
fun Modifier.textSize(textSize: TextUnit): Modifier {
    return this.then(ViewAttribute(object : AttributeApplier<TextView, Float> {
...
fun Modifier.textColor(textColor: Int): Modifier {
    return this.then(ViewAttribute(object : AttributeApplier<TextView, Int> {
...
fun Modifier.textAlign(textAlign: TextAlign): Modifier {
    return this.then(ViewAttribute(object : AttributeApplier<TextView, TextAlign> {
...
fun Modifier.ellipsis(ellipsis: TextTruncateAt): Modifier {
    return this.then(ViewAttribute(object : AttributeApplier<TextView, TextTruncateAt> {
...
fun Modifier.singleLine(singleLine: Boolean): Modifier {
    return this.thenViewAttribute<TextView, Boolean>(singleLine) {
        isSingleLine = it
    }
}
