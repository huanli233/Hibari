...
import com.huanli233.hibari.ui.geometry.MutableRect
import com.huanli233.hibari.ui.unit.Offset
import com.huanli233.hibari.ui.unit.Rect
import com.huanli233.hibari.ui.util.fastMaxOf
import com.huanli233.hibari.ui.util.fastMinOf
...
value class Matrix(
    ...
    fun map(rect: Rect): Rect {
        ...
        y = b
        inverseZ = 1.0f / (v03 * x + v13 * y + v33)
        pZ = if (inverseZ.isInfinite()) inverseZ else 0f
