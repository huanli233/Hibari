...
import com.huanli233.hibari.animation.AnimationConstants.DefaultDurationMillis
...
internal constructor(
    ...
    constructor(
        ...
        durationMillisArg: Int,
        delayMillisArg: Int = 0,
    ) : this(
        timestamps =
            Unit.run {
                ...
                if (!keyframes.containsKey(durationMillisArg)) {
                    times.add(durationMillisArg)
                }
                times.sort()
                return@run times
            },
        ...
        durationMillis = durationMillisArg,
        delayMillis = delayMillisArg,
...
value class ArcMode internal constructor(internal val value: Int) {
    ...
    companion object {
         ...
         * Ellipse.
         */
        val ArcAbove: ArcMode = ArcMode(ArcSplineArcAbove)

        /**
         * Interpolates using a quarter of an Ellipse where the curve is "below" the center of the
         * Ellipse.
         */
        val ArcBelow: ArcMode = ArcMode(ArcSplineArcBelow)
         ...
         */
        val ArcLinear: ArcMode = ArcMode(ArcSplineArcStartLinear)
    }
}
...
object Spring {
    ...
    const val DefaultDisplacementThreshold: Float = 0.01f
}
