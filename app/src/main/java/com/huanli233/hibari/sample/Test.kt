...
fun main() {
    ...
    val oldList2 = listOf(
        Node(2, Modifier.attribute(AttributeKey("dog"), Dog("Test1"), false))
    )
    val newList2 = listOf(
        Node(2, Modifier.attribute(AttributeKey("dog"), Dog("Test"), false))
    )
    ...
    val oldList3 = listOf(
        Node(3, Modifier.attribute(AttributeKey("title"), "test"))
    )
    val newList3 = listOf(
        Node(3, Modifier.attribute(AttributeKey("padding"), 7f).attribute(AttributeKey("title"), "test"))
    )
    ...
    val oldList5 = listOf(
        Node(KEY_ITEM_A, Modifier.attribute(ATTR_TITLE, "Item A")),
        Node(KEY_ITEM_B, Modifier.attribute(ATTR_ALPHA, 1.0f)),
        Node(KEY_ITEM_C, Modifier.attribute(ATTR_TITLE, "Item C"))
    )
    val newList5 = listOf(
        Node(KEY_ITEM_A, Modifier.attribute(ATTR_TITLE, "Item A")),
        Node(KEY_ITEM_C, Modifier.attribute(ATTR_TITLE, "Item C")),
        Node(KEY_ITEM_B, Modifier.attribute(ATTR_ALPHA, 0.5f)) // Alpha changed
    )
    ...
    val oldList6 = listOf(
        Node(KEY_HEADER, Modifier.attribute(ATTR_TITLE, "Old Header")),
        Node(KEY_ITEM_A, Modifier.attribute(ATTR_PADDING, 8)), // To be removed
        Node(KEY_ITEM_C, Modifier.attribute(ATTR_PADDING, 8)), // To be moved
        Node(KEY_FOOTER, Modifier.attribute(ATTR_TITLE, "Footer"))
    )
    val newList6 = listOf(
        Node(KEY_HEADER, Modifier.attribute(ATTR_TITLE, "New Header")), // Changed
        Node(KEY_ITEM_C, Modifier.attribute(ATTR_PADDING, 8)),         // Moved
        Node(KEY_NEW_ITEM, Modifier.attribute(ATTR_TITLE, "Newbie")),   // Inserted
        Node(KEY_FOOTER, Modifier.attribute(ATTR_TITLE, "Footer"))
    )
    ...
    val newList8A = listOf(
        Node(KEY_ITEM_A, Modifier.attribute(ATTR_TITLE, "A")),
        Node(KEY_ITEM_B, Modifier.attribute(ATTR_TITLE, "B"))
    )
