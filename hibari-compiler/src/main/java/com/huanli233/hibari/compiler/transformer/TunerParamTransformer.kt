        ...
        return deepCopyWithSymbolsAndMetadata(parent).also { fn ->
            ...
            fn.transformChildrenVoid(object : IrElementTransformerVoid() {
                ...
                override fun visitCall(expression: IrCall): IrExpression {
                    ...
                    if (!suppressGroupInjection && !isCurrentTunerCall && fn.fqNameWhenAvailable != FqName("com.huanli233.hibari.runtime.key") && owner.fqNameWhenAvailable != FqName("com.huanli233.hibari.runtime.key") && (wasTransformed || isEmitNodeCall)) {
