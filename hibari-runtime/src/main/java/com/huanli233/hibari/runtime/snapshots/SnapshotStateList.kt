...
internal constructor(persistentList: PersistentList<T>) :
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        repeat(size) { parcel.writeValue(list[it]) }
    }
        ...
        val CREATOR: Parcelable.Creator<SnapshotStateList<Any?>> =
            object : Parcelable.ClassLoaderCreator<SnapshotStateList<Any?>> {
                override fun createFromParcel(
                    ...
                    return SnapshotStateList(size = parcel.readInt()) {
                ...
                override fun newArray(size: Int) = arrayOfNulls<SnapshotStateList<Any?>?>(size)
            }
    }
}
