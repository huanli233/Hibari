...
package com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.implementations.immutableList

import com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.PersistentList
import com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.internal.ListImplementation.checkElementIndex
import com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.internal.ListImplementation.checkPositionIndex
import com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.internal.MutabilityOwnership
import com.huanli233.hibari.runtime.external.kotlinx.collections.immutable.internal.assert
...
internal class PersistentVectorBuilder<E>(private var vector: PersistentList<E>,
    ...
    private fun insertIntoRoot(root: Array<Any?>, shift: Int, index: Int, element: Any?, elementCarry: ObjectRef): Array<Any?> {
        ...
        if (shift == 0) {
            ...
            val mutableRoot = root.copyInto(makeMutable(root), bufferIndex + 1, bufferIndex,
    ...
    private fun insertIntoRoot(
        ...
        splitToBuffers(elements, index, startLeaf,
            MAX_BUFFER_SIZE, buffers, newNullBuffers, newNextBuffer)
    }
    ...
    private fun removeFromRootAt(root: Array<Any?>, shift: Int, index: Int, tailCarry: ObjectRef): Array<Any?> {
        ...
        if (shift == 0) {
            ...
            val mutableRoot = root.copyInto(makeMutable(root), bufferIndex, bufferIndex + 1,
                MAX_BUFFER_SIZE
            )
    ...
    private fun removeAll(predicate: (E) -> Boolean): Boolean {
        ...
        while (leafIterator.hasNext()) {
            ...
            bufferSize = recyclableRemoveAll(predicate, leaf,
                MAX_BUFFER_SIZE, bufferSize, bufferRef, recyclableBuffers, buffers)
        }
