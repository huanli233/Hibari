...
import com.huanli233.hibari.runtime.DerivedState
import com.huanli233.hibari.runtime.DerivedStateObserver
import com.huanli233.hibari.runtime.collection.ScopeMap
import com.huanli233.hibari.runtime.collection.fastForEach
import com.huanli233.hibari.runtime.collection.mutableVectorOf
import com.huanli233.hibari.runtime.hibariRuntimeError
import com.huanli233.hibari.runtime.internal.currentThreadId
import com.huanli233.hibari.runtime.internal.currentThreadName
import com.huanli233.hibari.runtime.observeDerivedStateRecalculations
import com.huanli233.hibari.runtime.platform.makeSynchronizedObject
import com.huanli233.hibari.runtime.platform.synchronized
import com.huanli233.hibari.runtime.requirePrecondition
import com.huanli233.hibari.runtime.structuralEqualityPolicy
...
class SnapshotStateObserver(private val onChangedExecutor: (callback: () -> Unit) -> Unit) {
    ...
    private fun report(): Nothing = hibariRuntimeError("Unexpected notification")
