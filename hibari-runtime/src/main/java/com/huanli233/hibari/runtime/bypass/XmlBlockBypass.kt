...
package com.huanli233.hibari.runtime.bypass
...
internal object XmlBlockBypass {
    ...
    fun newAttrSet(context: Context, @StyleRes resId: Int = Android_R.style.Widget): AttributeSet {
         ...
         */
        fun createViewAttrs() = Xml.asAttributeSet(context.resources.getLayout(R.layout.layout_hibari_attrs_view)) ?: error("Failed to create AttributeSet.")
